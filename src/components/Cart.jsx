...
const Cart = () => {
  ...
  if (cart) {
    if (cart.length === 0)
      return <PlaceHolder Icon={BsCartX} text={"Empty cart..."} />;
    return (
      <div className="cart-main-container">
              ...
              <div className="cart-product">
                ...
                <div className="quantity">
                  ...
                  <div className="quantity-controls">
                    <button
                      onClick={(e) =>
                        handleQuantity(e, product, product.quantity, product.id)
                      }
                    >
                      +
                    </button>
        ...
        <div className="card-payment">
            ...
            <div className="resume-infos">
              ...
              <div className="total">
                <p>TOTAL: <span>${(totalPrice * totalQuantity).toFixed(2)}</span></p>
              </div>
            </div>
